...
public class OrderFulfillment {
   ...
   * @return the OrderFulfillment instance itself
   */
  public OrderFulfillment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, orderFulfillment.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, orderFulfillment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, updatedAt, orderId, id, status, items, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderFulfillment>() {
           ...
           public OrderFulfillment read(JsonReader in) throws IOException {
             ...
             OrderFulfillment instance = thisAdapter.fromJsonTree(jsonObj);

...
public class OrderOrderData {
   ...
   * @return the OrderOrderData instance itself
   */
  public OrderOrderData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, orderOrderData.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, orderOrderData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, updatedAt, id, grn, number, status, channel, market, locale, additionalInfo, documents, items, payments, shipments, paymentsInfo, shipmentsInfo, promotions, currency, subtotals, totals, vatIncluded, billingAddress, shippingAddress, customerInfo, cartGrn, onHold, historyEvents, fulfillments, notes, isDeleted, insertedAt, deletedAt, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderOrderData>() {
           ...
           public OrderOrderData read(JsonReader in) throws IOException {
             ...
             OrderOrderData instance = thisAdapter.fromJsonTree(jsonObj);

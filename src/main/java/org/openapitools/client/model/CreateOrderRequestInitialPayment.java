...
public class CreateOrderRequestInitialPayment {
   ...
   * @return the CreateOrderRequestInitialPayment instance itself
   */
  public CreateOrderRequestInitialPayment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, createOrderRequestInitialPayment.code) &&
        ...
        Objects.equals(this.additionalProperties, createOrderRequestInitialPayment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, additionalInfo, amount, ccInfo, transaction, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateOrderRequestInitialPayment>() {
           ...
           public CreateOrderRequestInitialPayment read(JsonReader in) throws IOException {
             ...
             CreateOrderRequestInitialPayment instance = thisAdapter.fromJsonTree(jsonObj);

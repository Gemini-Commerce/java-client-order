...
public class OrderCreateShipmentRequest {
   ...
   * @return the OrderCreateShipmentRequest instance itself
   */
  public OrderCreateShipmentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderCreateShipmentRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderCreateShipmentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, orderId, items, address, fromAddress, returnAddress, tracking, returnTracking, code, method, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderCreateShipmentRequest>() {
           ...
           public OrderCreateShipmentRequest read(JsonReader in) throws IOException {
             ...
             OrderCreateShipmentRequest instance = thisAdapter.fromJsonTree(jsonObj);

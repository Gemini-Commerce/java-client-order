...
public class OrderDataShipmentInfo {
   ...
   * @return the OrderDataShipmentInfo instance itself
   */
  public OrderDataShipmentInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reference, orderDataShipmentInfo.reference) &&
        ...
        Objects.equals(this.additionalProperties, orderDataShipmentInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reference, code, method, title, additionalInfo, amount, fee, vatAmount, vatPercentage, vatInaccurate, vatCalculated, grn, fromAddress, returnAddress, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderDataShipmentInfo>() {
           ...
           public OrderDataShipmentInfo read(JsonReader in) throws IOException {
             ...
             OrderDataShipmentInfo instance = thisAdapter.fromJsonTree(jsonObj);

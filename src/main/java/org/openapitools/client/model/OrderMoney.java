...
public class OrderMoney {
  ...
  public OrderMoney units(String units) {
    this.units = units;
    return this;
  }
  ...
  public OrderMoney micros(Integer micros) {
    this.micros = micros;
    return this;
  }
   ...
   * @return the OrderMoney instance itself
   */
  public OrderMoney putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderMoney orderMoney = (OrderMoney) o;
    return Objects.equals(this.units, orderMoney.units) &&
        Objects.equals(this.micros, orderMoney.micros)&&
        Objects.equals(this.additionalProperties, orderMoney.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderMoney.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderMoney is not found in the empty JSON string", OrderMoney.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderMoney.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderMoney' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderMoney> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderMoney.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderMoney>() {
           @Override
           public void write(JsonWriter out, OrderMoney value) throws IOException {
           ...
           @Override
           public OrderMoney read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OrderMoney instance = thisAdapter.fromJsonTree(jsonObj);

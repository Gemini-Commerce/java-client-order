...
public class InitialPaymentInitialTransaction {
   ...
   * @return the InitialPaymentInitialTransaction instance itself
   */
  public InitialPaymentInitialTransaction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, initialPaymentInitialTransaction.type) &&
        ...
        Objects.equals(this.additionalProperties, initialPaymentInitialTransaction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, additionalInfo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InitialPaymentInitialTransaction>() {
           ...
           public InitialPaymentInitialTransaction read(JsonReader in) throws IOException {
             ...
             InitialPaymentInitialTransaction instance = thisAdapter.fromJsonTree(jsonObj);

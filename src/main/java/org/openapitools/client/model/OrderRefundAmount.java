...
public class OrderRefundAmount {
   ...
   * @return the OrderRefundAmount instance itself
   */
  public OrderRefundAmount putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, orderRefundAmount.code) &&
        ...
        Objects.equals(this.additionalProperties, orderRefundAmount.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderRefundAmount>() {
           ...
           public OrderRefundAmount read(JsonReader in) throws IOException {
             ...
             OrderRefundAmount instance = thisAdapter.fromJsonTree(jsonObj);

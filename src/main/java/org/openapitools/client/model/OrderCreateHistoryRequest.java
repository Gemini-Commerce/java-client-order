...
public class OrderCreateHistoryRequest {
   ...
   * @return the OrderCreateHistoryRequest instance itself
   */
  public OrderCreateHistoryRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderCreateHistoryRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderCreateHistoryRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, orderId, comment, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderCreateHistoryRequest>() {
           ...
           public OrderCreateHistoryRequest read(JsonReader in) throws IOException {
             ...
             OrderCreateHistoryRequest instance = thisAdapter.fromJsonTree(jsonObj);

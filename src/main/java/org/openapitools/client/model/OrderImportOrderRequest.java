...
public class OrderImportOrderRequest {
   ...
   * @return the OrderImportOrderRequest instance itself
   */
  public OrderImportOrderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderImportOrderRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderImportOrderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, createdAt, number, channel, market, locale, customerInfo, shippingAddress, billingAddress, payments, paymentsInfo, shipmentsInfo, items, subtotals, totals, status, currency, vatIncluded, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderImportOrderRequest>() {
           ...
           public OrderImportOrderRequest read(JsonReader in) throws IOException {
             ...
             OrderImportOrderRequest instance = thisAdapter.fromJsonTree(jsonObj);

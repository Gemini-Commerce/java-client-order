...
public class OrderStatusFilter {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(statuses, condition);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderStatusFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderStatusFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

...
public class ShipmentTracking {
   ...
   * @return the ShipmentTracking instance itself
   */
  public ShipmentTracking putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.carrierCode, shipmentTracking.carrierCode) &&
        ...
        Objects.equals(this.additionalProperties, shipmentTracking.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(carrierCode, carrierTitle, url, number, labelUrl, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ShipmentTracking>() {
           ...
           public ShipmentTracking read(JsonReader in) throws IOException {
             ...
             ShipmentTracking instance = thisAdapter.fromJsonTree(jsonObj);

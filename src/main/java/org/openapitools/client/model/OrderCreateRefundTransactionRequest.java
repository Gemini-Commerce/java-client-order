...
public class OrderCreateRefundTransactionRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, refundId, parentTransactionId, type, additionalInfo);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderCreateRefundTransactionRequest.openapiFields.contains(entry.getKey())) {

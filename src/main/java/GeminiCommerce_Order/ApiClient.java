...
import GeminiCommerce_Order.auth.Authentication;
import GeminiCommerce_Order.auth.HttpBasicAuth;
import GeminiCommerce_Order.auth.HttpBearerAuth;
import GeminiCommerce_Order.auth.ApiKeyAuth;
import GeminiCommerce_Order.auth.OAuth;
import GeminiCommerce_Order.auth.RetryingOAuth;
import GeminiCommerce_Order.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://dom.api.gogemini.io";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://dom.api.gogemini.io",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dom.api.gogemini.io
     ...
     * @return a {@link GeminiCommerce_Order.ApiClient} object
     */
     ...
     * @throws GeminiCommerce_Order.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce_Order.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce_Order.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce_Order.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce_Order.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce_Order.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce_Order.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce_Order.ApiException If fail to serialize the request body object into a string
     */

...
public class PaymentCcInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(approval, expMonth, expYear, last4, numberEnc, owner, avsStatus, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentCcInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentCcInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

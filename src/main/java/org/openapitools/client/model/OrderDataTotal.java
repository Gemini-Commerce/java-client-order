...
public class OrderDataTotal {
   ...
   * @return the OrderDataTotal instance itself
   */
  public OrderDataTotal putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, orderDataTotal.code) &&
        ...
        Objects.equals(this.additionalProperties, orderDataTotal.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderDataTotal>() {
           ...
           public OrderDataTotal read(JsonReader in) throws IOException {
             ...
             OrderDataTotal instance = thisAdapter.fromJsonTree(jsonObj);

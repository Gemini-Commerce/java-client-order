...
public class OrderCancelOrderRequest {
   ...
   * @return the OrderCancelOrderRequest instance itself
   */
  public OrderCancelOrderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderCancelOrderRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderCancelOrderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, orderId, reason, options, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderCancelOrderRequest>() {
           ...
           public OrderCancelOrderRequest read(JsonReader in) throws IOException {
             ...
             OrderCancelOrderRequest instance = thisAdapter.fromJsonTree(jsonObj);

...
public class OrderDataPaymentInfo {
   ...
   * @return the OrderDataPaymentInfo instance itself
   */
  public OrderDataPaymentInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, orderDataPaymentInfo.code) &&
        ...
        Objects.equals(this.additionalProperties, orderDataPaymentInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, additionalInfo, amount, fee, vatAmount, vatPercentage, vatInaccurate, vatCalculated, title, label, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderDataPaymentInfo>() {
           ...
           public OrderDataPaymentInfo read(JsonReader in) throws IOException {
             ...
             OrderDataPaymentInfo instance = thisAdapter.fromJsonTree(jsonObj);

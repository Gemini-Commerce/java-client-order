...
public class OrderCreatePaymentTransactionRequest {
   ...
   * @return the OrderCreatePaymentTransactionRequest instance itself
   */
  public OrderCreatePaymentTransactionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderCreatePaymentTransactionRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderCreatePaymentTransactionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, paymentId, type, additionalInfo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderCreatePaymentTransactionRequest>() {
           ...
           public OrderCreatePaymentTransactionRequest read(JsonReader in) throws IOException {
             ...
             OrderCreatePaymentTransactionRequest instance = thisAdapter.fromJsonTree(jsonObj);

...
import GeminiCommerce.Order.auth.Authentication;
import GeminiCommerce.Order.auth.HttpBasicAuth;
import GeminiCommerce.Order.auth.HttpBearerAuth;
import GeminiCommerce.Order.auth.ApiKeyAuth;
import GeminiCommerce.Order.auth.OAuth;
import GeminiCommerce.Order.auth.RetryingOAuth;
import GeminiCommerce.Order.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Order.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Order.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Order.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Order.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Order.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Order.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Order.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Order.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Order.ApiException If fail to serialize the request body object into a string
     */

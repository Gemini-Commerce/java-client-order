...
public class OrderCreatePaymentRequest {
   ...
   * @return the OrderCreatePaymentRequest instance itself
   */
  public OrderCreatePaymentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderCreatePaymentRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderCreatePaymentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, orderId, code, additionalInfo, amount, ccInfo, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderCreatePaymentRequest>() {
           ...
           public OrderCreatePaymentRequest read(JsonReader in) throws IOException {
             ...
             OrderCreatePaymentRequest instance = thisAdapter.fromJsonTree(jsonObj);

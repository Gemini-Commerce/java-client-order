...
public class OrderCreateOrderRequest {
   ...
   * @return the OrderCreateOrderRequest instance itself
   */
  public OrderCreateOrderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, orderCreateOrderRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, orderCreateOrderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, number, channel, market, locale, items, paymentsInfo, shipmentsInfo, promotions, payments, currency, subtotals, totals, vatIncluded, billingAddress, shippingAddress, customerInfo, cartGrn, onHold, notes, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderCreateOrderRequest>() {
           ...
           public OrderCreateOrderRequest read(JsonReader in) throws IOException {
             ...
             OrderCreateOrderRequest instance = thisAdapter.fromJsonTree(jsonObj);

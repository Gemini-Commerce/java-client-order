...
public class OrderDataCustomerInfo {
   ...
   * @return the OrderDataCustomerInfo instance itself
   */
  public OrderDataCustomerInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.grn, orderDataCustomerInfo.grn) &&
        ...
        Objects.equals(this.additionalProperties, orderDataCustomerInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(grn, firstname, lastname, email, phone, segment, data, certifiedEmail, taxCode, sdiCode, fiscalCode, companyName, agentGrn, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderDataCustomerInfo>() {
           ...
           public OrderDataCustomerInfo read(JsonReader in) throws IOException {
             ...
             OrderDataCustomerInfo instance = thisAdapter.fromJsonTree(jsonObj);
